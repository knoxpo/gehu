...
import type { CleanupFn, StateOf, Store, StoreMutation, StoreResource } from '@gehu/core';
...
export function createTestStore<T>(store: Store<T>, options: TestStoreOptions<T> = {}): TestStore<T> {
