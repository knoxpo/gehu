...
export const GEHU_HYDRATION = new InjectionToken<Record<string, unknown>>("gehu.hydration");
...
export function tokenFor(store: Store<unknown> | object): InjectionToken<unknown> {
